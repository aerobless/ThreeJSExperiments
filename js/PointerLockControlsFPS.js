...
*/
    ...
    this.update = function ( delta ) {
        ...
        //quat.setFromEuler(test);
        //quat.setFromEuler(new THREE.Euler(_x: yawObject.rotation.y, _y: yawObject.rotation.y, _z: yawObject.rotation.y));
        quat.setFromAxisAngle(new CANNON.Vec3(0,1,0), yawObject.rotation.y);
